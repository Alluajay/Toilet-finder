...
import com.example.allu.toiletfinder.UI.Fragments.AboutUsFragment;
import com.example.allu.toiletfinder.UI.Fragments.HomeFragment;
import com.example.allu.toiletfinder.UI.Fragments.PostToilet;
import com.example.allu.toiletfinder.interfaces.FragmentSetListener;
import com.example.allu.toiletfinder.interfaces.LocationChangeListener;
...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.locateToilet));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_logout:
                ...
                nav_Login.findItem(R.id.nav_login).setVisible(!utils.isLoggedIn());
                break;
            case R.id.nav_postToilet:
                setTitle(getString(R.string.postToilet));
                startActivity(new Intent(this,CreateToiletActivity.class));
                break;
